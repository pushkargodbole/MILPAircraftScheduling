...
from plotschedule2 import plotschedule
...
def animschedule(mapfile, mapplotfile, schedulefile, flightfile):
    ...
    plot, = ax.plot(flightsx, flightsy, 'k^')
    fig.canvas.draw()
    ...
    for ti in arange(0, tmax, dt):
        ...
        for i in range(len(flights)):
            ann[i] = ax.annotate(flights[i], (flightsx[i],flightsy[i]))
...
if __name__ == "__main__":
    if len(sys.argv) == 5:    
        ...
        print "4 arguments expected,", sys.argc-1, "given."
